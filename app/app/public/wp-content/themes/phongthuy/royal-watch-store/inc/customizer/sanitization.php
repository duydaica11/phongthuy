 ...
 */
function royalwatchstore_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function royalwatchstore_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function royalwatchstore_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function royalwatchstore_sanitize_float( $input ) {
 ...
 */
function royalwatchstore_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function royalwatchstore_sanitize_html( $html ) {
 ...
 */
function royalwatchstore_sanitize_image( $image, $setting ) {
 ...
 */
function royalwatchstore_sanitize_nohtml( $nohtml ) {
 ...
 */
function royalwatchstore_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function royalwatchstore_sanitize_range_value( $number, $setting ) {
 ...
 */
function royalwatchstore_sanitize_select( $input, $setting ) {
 ...
 */
function royalwatchstore_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function royalwatchstore_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function royalwatchstore_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
