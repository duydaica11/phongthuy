...
class Widgets {
	...
	public function init_widgets() {
		...
		$widgets_manager->register( new \Razzi\Addons\Elementor\Widgets\Category_List() );
		...
		if ( class_exists( 'WooCommerce' ) ) {
			...
			$widgets_manager->register( new \Razzi\Addons\Elementor\Widgets\Products_Deal_3() );
			...
			$widgets_manager->register( new \Razzi\Addons\Elementor\Widgets\Products_Listing_2() );
			$widgets_manager->register( new \Razzi\Addons\Elementor\Widgets\Product_Brands() );
		}
	}
}
