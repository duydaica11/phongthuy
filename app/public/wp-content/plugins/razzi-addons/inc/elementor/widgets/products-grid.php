...
class Products_Grid extends Widget_Base {
	...
	protected function section_content_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .razzi-products-grid ul.products li.product .product-inner' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .razzi-products-grid ul li.product .product-inner:not(:hover)',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Product Padding Bottom', 'razzi' ),
				'type'      => Controls_Manager::SLIDER,
				'size_units' => [ 'px'],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'     => __( 'Product Margin Bottom', 'razzi' ),
				'type'      => Controls_Manager::SLIDER,
				'size_units' => [ 'px'],
				'selectors'  => [
	...
	protected function render() {
		...
		$product_ids = ! empty($settings['ids']) ? explode(',', $settings['ids']) : array();
		$attr = [
