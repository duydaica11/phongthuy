...
class Products_Listing extends Widget_Base {
	...
	protected function section_products_settings_controls() {
		...
		$this->add_control(
			'show_product_cat',
			[
				'label'        => esc_html__( 'Show Product Category', 'razzi' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'razzi' ),
				'label_off'    => esc_html__( 'Hide', 'razzi' ),
				'return_value' => 'yes',
	...
	protected function section_content_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Products Listing', 'razzi' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);

		$this->add_control(
			'products_listing_bg_color',
			[
				'label'     => esc_html__( 'Background Color', 'razzi' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .razzi-products-listing' => 'background-color: {{VALUE}};',
				],
			]
		);

		$this->add_responsive_control(
			'products_listing_padding',
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .razzi-products-listing' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'products_listing_box_shadow',
				'label' => __( 'Box Shadow', 'razzi' ),
				'selector' => 	'{{WRAPPER}} .razzi-products-listing',
			]
		);


		$this->add_responsive_control(
			'products_listing_border_radius',
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .razzi-products-listing' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .razzi-products-listing__heading--arrows' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		...
		$this->add_group_control(
			...
			[
				'name'      => 'heading_border',
				'selector'  => '{{WRAPPER}} .razzi-products-listing__heading--arrows',
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .razzi-products-listing__item-box' => 'min-height: {{SIZE}}{{UNIT}};',
				],
	...
	protected function get_categories_content( $settings ) {
		...
		foreach ( $product_ids as $product_id ) {
			...
			$output[] = '<div class="razzi-products-listing__item-box">';
			if( $image ) {
			...
			if( $settings['show_product_cat'] == 'yes' ) {
				$terms = get_the_terms( $product_id, 'product_cat' );
				if( ! is_wp_error( $terms ) && ! empty( $terms ) ) {
					$output[] = '<a class="razzi-products-listing__item-cat" href="'. get_term_link($terms[0]) .'">';
					$output[] = $terms[0]->name;
					$output[] = '</a>';
				}
