...
class Icon_Box extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'show_icon_arrow',
			[
				'label'     => __( 'Show Icon Arrow', 'razzi' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.elementor-view-stacked .razzi-icon__icon' => 'background-color: {{VALUE}};',
					'{{WRAPPER}}.elementor-view-framed .razzi-icon__icon, {{WRAPPER}}.elementor-view-default .razzi-icon__icon' => 'fill: {{VALUE}}; color: {{VALUE}}; border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.elementor-view-framed .razzi-icon__icon' => 'background-color: {{VALUE}};',
					'{{WRAPPER}}.elementor-view-stacked .razzi-icon__icon' => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.elementor-view-stacked .razzi-icon__icon:hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}}.elementor-view-framed .razzi-icon__icon:hover, {{WRAPPER}}.elementor-view-default .razzi-icon__icon:hover' => 'fill: {{VALUE}}; color: {{VALUE}}; border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}}.elementor-view-framed .razzi-icon__icon:hover' => 'background-color: {{VALUE}};',
					'{{WRAPPER}}.elementor-view-stacked .razzi-icon__icon:hover' => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .razzi-icon__icon' => 'font-size: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .razzi-icon__icon' => 'padding: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .razzi-icon__icon' => 'transform: rotate({{SIZE}}{{UNIT}});',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .razzi-icon__icon' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .razzi-icon__icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .razzi-icon-box__title' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		$classes = $settings['icon_type'] === 'icon' ? 'razzi-svg-icon razzi-icon__icon' : 'razzi-img-icon';
		...
		<div class="razzi-icon-box">
			...
			<?php endif; ?>
			<div class="razzi-icon-box__content<?php echo $settings['show_icon_arrow'] ? ' razzi-icon-box__show-arrow' : '' ?>">
				...
				<?php if ( $settings['show_icon_arrow'] ) : ?>
					<<?php Utils::print_validated_html_tag( $icon_tag ); ?> <?php $this->print_render_attribute_string( 'link' ); ?> class="razzi-icon-box__icon-arrow">
						<?php echo \Razzi\Addons\Helper::get_svg( 'arrow-right', 'razzi-icon' ) ; ?>
					</<?php Utils::print_validated_html_tag( $icon_tag ); ?>>
				<?php endif; ?>
			</div>
		</div>
