...
class Socials_Walker extends \Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$host_url = isset($parse_url['host']) ? $parse_url['host'] : $parse_url['scheme'];
		...
		if ( strpos( $url_name, 'google') ) {
			$url_name = 'google';
		} elseif ( strpos( $url_name, 't.me') || $url_name == 't.me' ) {
			$url_name = 'telegram';
		} elseif ( strpos( $url_name, 'whatsapp') ) {
			$url_name = 'whatsapp';
		} elseif ( $url_name == 'wa.me') {
			$url_name = 'whatsapp';
		} elseif ( strstr( $url_name, 'pinterest') ) {
			$url_name = 'pinterest';
		} elseif ( $url_name == 'mailto') {
			$url_name = 'mail';
		}
