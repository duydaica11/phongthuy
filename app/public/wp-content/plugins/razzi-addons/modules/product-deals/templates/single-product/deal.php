...
<div class="razzi-product-deal deal <?php echo esc_attr( $class ); ?>" data-variation="<?php echo esc_attr( $variation_id ); ?>">
	<?php if ( $expire || $class == 'hidden' ) : ?>
    ...
    <div class="deal-sold">
        ...
        <div class="deal-progress">
            <div class="progress-bar">
                <div class="progress-value" style="width: <?php echo ( $sold == 0 && $limit == 0 ) ? 0 : $sold / $limit * 100; ?>%"></div>
            </div>
