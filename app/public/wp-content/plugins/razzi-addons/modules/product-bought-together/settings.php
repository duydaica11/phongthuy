...
class Settings  {
	...
	public function product_bought_together_section( $sections ) {
		$sections['rz_product_bought_together'] = esc_html__( 'Product Bought Together', 'razzi' );
	...
	public function product_bought_together_settings( $settings, $section ) {
		if ( 'rz_product_bought_together' == $section ) {
			$settings = array();

			$settings[] = array(
				'id'    => 'rz_product_bought_together_options',
				'title' => esc_html__( 'Product Bought Together', 'razzi' ),
				'type'  => 'title',
			);

			$settings[] = array(
				'id'      => 'rz_product_bought_together',
				'title'   => esc_html__( 'Product Bought Together', 'razzi' ),
				'desc'    => esc_html__( 'Enable Product Bought Together', 'razzi' ),
				'type'    => 'checkbox',
				'default' => 'no',
			);
