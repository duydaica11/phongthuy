...
class Helper {
	...
	public static function get_popup_html( $product ) {
		...
		wc_get_template(
			...
			'',
			RAZZI_ADDONS_DIR . 'modules/live-sales-notification/templates/'
		);
	...
	public static function format_product_obj($product, $order) {
		...
		$time_passed_type = $time_type[get_option( 'razzi_live_sales_notification_time_passed_type')];
	...
	public static function product_link( $product ) {
        ...
        return apply_filters( 'razzi_live_sales_notification_product_link', $link, $product );
    }
