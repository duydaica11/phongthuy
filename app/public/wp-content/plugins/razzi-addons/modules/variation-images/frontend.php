...
class Frontend {
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'razzi_variation_images', RAZZI_ADDONS_URL . '/modules/variation-images/js/variation-images-frontend.js', array( 'jquery' ), '20220319', true );
	}

	public function get_variation_images() {
		check_ajax_referer( '_razzi_nonce', 'nonce' );
