...
<div class=\"mailpoet-top-bar\">
  <a role=\"button\" class=\"mailpoet-top-bar-logo\" title=\"";
        // line 9
        echo $this->extensions['MailPoet\Twig\I18n']->translate("Back to section root", "mailpoet");
...
<div class=\"mailpoet-premium-page\">
  ";
    ...
    <h1 class=\"mailpoet-h0\">
      ";
            // line 22
            echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("MailPoet Starter plan is yours for free", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
            echo "
    </h1>
    ...
    <a
      ...
      href=\"";
            // line 29
            echo \MailPoetVendor\twig_escape_filter($this->env, ((("https://account.mailpoet.com/?s=" . ($context["subscriber_count"] ?? null)) . "&g=starter&billing=monthly&utm_source=plugin&utm_medium=premium&utm_campaign=purchase&ref=plugin-upgrade-page&email=") . \MailPoetVendor\twig_escape_filter($this->env, \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 29))), "html", null, true);
            echo "\"
    ...
    <div class=\"mailpoet-premium-page-options mailpoet-grid-two-columns\">
      <div>
        ...
        <p class=\"mailpoet-premium-page-text-large\">
          ";
        // line 58
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("From <b>\$10/month</b><br>for 500 contacts", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "
        </h3>
        <ul>
          <li>";
        // line 61
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("MailPoet Sending Service", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "</li>
          <li>";
        // line 62
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Send unlimited emails per month", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "</li>
          <li>";
        // line 63
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Remove MailPoet branding", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "</li>
          <li>";
        // line 64
        ...
        echo "</li>
          <li>";
        // line 66
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Targeted marketing automation", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "</li>
          <li>";
        // line 67
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Detailed email engagement and ecommerce statistics", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "</li>
        </ul>
        <a
          target=\"_blank\"
        ...
        if (($context["has_valid_api_key"] ?? null)) {
          ...
          ";
            ...
            // line 74
            echo "            href=\"";
            echo \MailPoetVendor\twig_escape_filter($this->env, (((("https://account.mailpoet.com/?s=" . ($context["subscriber_count"] ?? null)) . "&g=business&billing=monthly&email=") . \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 74)) . "&utm_source=plugin&utm_medium=premium&utm_campaign=purchase&ref=plugin-upgrade-page"), "html", null, true);
            echo "\"
          ";
        }
        // line 76
        echo "        class=\"mailpoet-button button button-primary button-hero mailpoet-premium-shop-link\"
        >
          ";
        // line 78
      ...
      <div>
        ...
        <p class=\"mailpoet-premium-page-text-large\">
          ";
        // line 87
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("From <b>\$8/month</b><br>for 500 contacts", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "
        </p>
        ...
        <p>
          ";
        // line 91
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Want to manage your own email sending? Our Creator plan offers all the features of the Business plan <b>without the MailPoet Sending Service</b>.", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "
        </p>
        <div class=\"mailpoet-premium-page-options-divider\"></div>
        <a
        ...
        if (($context["has_valid_api_key"] ?? null)) {
          ...
          ";
            ...
            // line 99
            echo "            href=\"";
            echo \MailPoetVendor\twig_escape_filter($this->env, (((("https://account.mailpoet.com/?s=" . ($context["subscriber_count"] ?? null)) . "&g=creator&billing=monthly&email=") . \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 99)) . "&utm_source=plugin&utm_medium=premium&utm_campaign=purchase&ref=plugin-upgrade-page"), "html", null, true);
            echo "\"
          ";
        }
        // line 101
  ...
  <div class=\"mailpoet-premium-page-section mailpoet-premium-page-section-narrow mailpoet-premium-page-text-center\">
    ...
    <p class=\"mailpoet-premium-page-text-large\">
      ";
        // line 116
        echo $this->extensions['MailPoet\Twig\I18n']->translateWithContext("Over 700,000 people trust MailPoet to power their email marketing campaigns – why not join them?!", "This text resides in the Upgrade page: /wp-admin/admin.php?page=mailpoet-upgrade");
        echo "
      ";
        // line 117
    ...
    <a
      ...
      ";
            ...
            // line 124
            echo "        href=\"";
            echo \MailPoetVendor\twig_escape_filter($this->env, (((("https://account.mailpoet.com/?s=" . ($context["subscriber_count"] ?? null)) . "&g=business&billing=monthly&email=") . \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 124)) . "&utm_source=plugin&utm_medium=premium&utm_campaign=purchase&ref=plugin-upgrade-page"), "html", null, true);
            echo "\"
      ";
        }
        // line 126
...
";
    ...
    {
        return array (  330 => 150,  326 => 149,  318 => 144,  314 => 143,  305 => 136,  303 => 135,  301 => 132,  299 => 131,  293 => 128,  289 => 126,  283 => 124,  277 => 122,  275 => 121,  268 => 117,  264 => 116,  258 => 113,  245 => 103,  241 => 101,  235 => 99,  229 => 97,  227 => 96,  219 => 91,  212 => 87,  206 => 84,  197 => 78,  193 => 76,  187 => 74,  181 => 72,  179 => 71,  172 => 67,  168 => 66,  164 => 65,  160 => 64,  156 => 63,  152 => 62,  148 => 61,  142 => 58,  136 => 55,  129 => 51,  120 => 45,  116 => 44,  110 => 41,  105 => 38,  96 => 32,  90 => 29,  83 => 25,  77 => 22,  73 => 20,  71 => 19,  58 => 9,  51 => 4,  47 => 3,  36 => 1,);
    }
