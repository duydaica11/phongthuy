	...
	public function register_required_plugins() {
		$plugins = array(
			...
			array(
				...
				'slug'               => 'razzi-addons',
				'source'             => esc_url( 'https://github.com/drfuri/plugins/raw/main/razzi-addons.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '2.0.9',
			...
			array(
				'name'               => esc_html__( 'WCBoost - Wishlist', 'razzi' ),
			...
			array(
				'name'               => esc_html__( 'WCBoost - Products Compare', 'razzi' ),
