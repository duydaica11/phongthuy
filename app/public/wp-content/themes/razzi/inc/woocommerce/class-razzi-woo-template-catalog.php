...
class Catalog {
	...
	public function products_filter() {
		if ( ! Helper::get_option('catalog_toolbar_products_filter_toggle') || ! is_active_sidebar( 'catalog-filters-sidebar' ) ) {
			return;
		}
		...
		if ( 'category' == $type ) {
			...
			if ( ! is_numeric( Helper::get_option( 'catalog_toolbar_tabs_categories' ) ) && ! empty( Helper::get_option( 'catalog_toolbar_tabs_categories' ) ) ) {
				if( Helper::get_option( 'catalog_toolbar_tabs_subcategories' ) && ! is_shop() ) {
					$terms = $this->get_terms_product_cat( Helper::get_option( 'catalog_toolbar_tabs_categories' ), Helper::get_option( 'catalog_toolbar_tabs_subcategories' ), Helper::get_option( 'catalog_toolbar_tabs_categories_order' ) );
