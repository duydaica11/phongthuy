...
<div class="yith-wcwl-add-button yith-wcwl-wishlistexistsbrowse">
	<a
		href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'remove_from_wishlist', $product_id, $base_url ), 'remove_from_wishlist' ) ); ?>"
		class="rz-loop_button delete_item <?php echo esc_attr( $link_classes ); ?>"
	...
	<?php if ( $show_view ) : ?>
		<span class="separator"><?php esc_html_e( 'or', 'razzi' ); ?></span>
		<a href="<?php echo esc_url( $found_in_list->get_url() ); ?>" class="view-wishlist"><?php echo esc_html( apply_filters( 'yith_wcwl_view_wishlist_label', __( 'View &rsaquo;', 'razzi' ) ) ); ?></a>
	<?php endif; ?>
</div>
