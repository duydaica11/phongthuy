...
class Category {
	...
	public function __construct() {
		...
		// Add form Brand
		add_action( 'product_brand_add_form_fields', array( $this, 'add_brand_fields' ), 30 );
		add_action( 'product_brand_edit_form_fields', array( $this, 'edit_brand_fields' ), 20 );
	...
	public function register_admin_scripts( $hook ) {
		...
		if ( ( $hook == 'edit-tags.php' && ( $screen->taxonomy == 'product_cat' || $screen->taxonomy == 'product_brand' || $screen->taxonomy == 'product_author' ) ) || ( $hook == 'term.php' && ( $screen->taxonomy == 'product_cat' || $screen->taxonomy == 'product_brand' ) ) ) {
			wp_enqueue_media();
	...
	public function add_brand_fields() {
		if( \Razzi\Helper::get_option( 'catalog_page_header' ) == 'layout-2' ) : ?>
		<div class="form-field">
            <label><?php esc_html_e( 'Page Header Background', 'razzi' ); ?></label>
	...
	public function save_category_fields( $term_id, $tt_id = '', $taxonomy = '' ) {
		...
		if ( 'product_brand' === $taxonomy && function_exists( 'update_term_meta' ) ) {
			if ( isset( $_POST['rz_page_header_bg_id'] ) ) {
				update_term_meta( $term_id, 'rz_page_header_bg_id', $_POST['rz_page_header_bg_id'] );
			}
		}
