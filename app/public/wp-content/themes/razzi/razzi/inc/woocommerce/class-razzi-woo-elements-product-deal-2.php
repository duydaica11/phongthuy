...
class Product_Deal_2 {
	...
	public function __construct() {
		...
		// Add product deal
		add_action( 'razzi_deal2_woocommerce_after_shop_loop_item_title', array( $this, 'product_deal_outside' ), 20 );
	 ...
	 * @return string
	 */
	public function product_loop_thumbnail( $position ) {
	 ...
	 * @return void
	 */
	public function product_deal_outside( $position ) {
		if ( $position != 'outside' ) {
			return;
		}
