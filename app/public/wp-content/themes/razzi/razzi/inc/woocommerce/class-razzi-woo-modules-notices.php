...
class Notices {
    ...
    public function product_template_recommended() {
        ...
        if ( isset( $_POST['product_id'] ) && ! empty( $_POST['product_id'] )  ) {
            ...
            if ( 'related_products' == $type ) {
                $product_ids = maybe_unserialize( get_post_meta( $product_id, 'razzi_related_product_ids', true ) );
    ...
    */
    public function notices_script_data( $data ) {
        ...
        if ( intval( Helper::get_option( 'added_to_wishlist_notice' ) ) && ( defined( 'YITH_WCWL' ) || shortcode_exists( 'wcboost_wishlist_button' ) ) ) {
        ...
        if ( intval( Helper::get_option( 'added_to_compare_notice' ) ) && function_exists( 'wcboost_products_compare' ) ) {
            $url = wc_get_page_permalink( 'compare' );

            $data['added_to_compare_notice'] = array(
                'added_to_compare_text'    => esc_html__( 'has been added to your compare.', 'razzi' ),
                'added_to_compare_texts'   => esc_html__( 'have been added to your compare.', 'razzi' ),
                'compare_view_text'        => esc_html__( 'View Compare', 'razzi' ),
