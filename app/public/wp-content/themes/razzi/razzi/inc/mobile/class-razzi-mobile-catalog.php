...
class Catalog {
				...
				<div class="mobile-catalog-page-header mobile-catalog-page-header--<?php echo esc_attr($layout); ?>">
					...
					<div class="page-header__content">
						<?php
							...
							if( intval( \Razzi\Helper::get_option( 'taxonomy_description_enable' ) ) && \Razzi\Helper::get_option( 'taxonomy_description_position' ) == 'above' && function_exists('woocommerce_taxonomy_archive_description') ) {
	 ...
	 * @return string
	 */
	public function get_product_filters_modal_classes( $classes ) {
		$classes = 'has-collapse-' . Helper::get_option( 'mobile_catalog_collapse_filter_content_status' );
		return $classes;
	}
}
