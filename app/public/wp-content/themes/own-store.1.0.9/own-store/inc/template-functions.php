...
function own_store_remove_blocks_cart ($wp_classes) {
    if ( own_shop_is_active_woocommerce() ) :
...
add_filter( 'body_class', 'own_store_remove_blocks_cart' );
 ...
 */
 ...
 function own_store_body_topbar_class_add( $classes ) {
...
add_filter( 'body_class', 'own_store_body_topbar_class_add' );